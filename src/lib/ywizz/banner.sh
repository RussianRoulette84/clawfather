...
show_banner() {
    ...
    center_ascii "${C8}  \______/ |________/|__/  |__/|__/     \__/|__/     |__/  |__/   |__/   |__/  |__/|________/|__/  |__/                       ${accent_color}${CLAWFATHER_VERSION:-v1.1} by: RussianRoulette84${RESET}" 20
    printf "\n"
}
...
show_banner_combined() {
    ...
    printf "   %b\n" "${C6}⠀⠀⠀⠈⠂⣀⠀⠀⠀⠀⢠⠟⠉⠀⠀⠀⠀⠀⠀⠀${NC}"
    printf "   %b\n" "${C7}⠀⠀⠀⠀⠀⠘⠓⠂⠀⠐⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀                       ${accent_color}${CLAWFATHER_VERSION:-v1.1} by: RussianRoulette84${RESET}"
}
